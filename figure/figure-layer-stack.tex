...
\end{tikzpicture}
    ...
    9ec79a095ef4db1fc5edc5e4059f5a10}. It's rootfs ID is stored it's meta data file \textit{state.json}. The stack list is stored in file \textit{./aufs/layers/febfb1642ebeb2585-7bf2a9c558bf695}. On the top is the \textit{container layer}, the only writable storage layer for this container.}
    \label{fig:stacklist}
\end{figure}
