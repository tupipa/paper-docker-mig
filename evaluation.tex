...
\begin{figure}[tb!]
    ...
    {figure/predump-docker-tarssh.eps}
    \caption{Time of Container Migration Stages without pipeline}
    \label{fig:nopipe}
\end{figure}
...
\begin{figure}[tb!]
    ...
    \includegraphics[width=0.48\textwidth]
    % {figure/test-tarssh.eps}
    {figure/predump-docker-pipe.eps}
    
    \caption{Time of Container Migration Stages with pipeline}
    \label{fig:pipe}
\end{figure}
